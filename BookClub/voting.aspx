<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="voting.aspx.cs" Inherits="BookClub.voting" %>
...
<header>
    ...
    <ul>
        <li><a href="voting.aspx" class="active">Voting</a></li>
